...
const PLAYERS = [
  ...
  { id: 'BK-4827193', risk: KGEnums.RISK.HIGH, riskScore: 89, riskFrom: 62, trend: 'up', spend: 1842500, spendDelta: 142,
  ...
  { id: 'SS-7283910', risk: KGEnums.RISK.HIGH, riskScore: 92, riskFrom: 71, trend: 'up', spend: 24300, spendDelta: 215,
    ...
    status: KGEnums.PLAYER_STATUS.OUTREACH },
  { id: 'BK-3918274', risk: KGEnums.RISK.HIGH, riskScore: 81, riskFrom: 58, trend: 'up', spend: 985000, spendDelta: 98,
  ...
  { id: 'BK-5621847', risk: KGEnums.RISK.MEDIUM, riskScore: 61, riskFrom: 41, trend: 'up', spend: 412800, spendDelta: 67,
    ...
    status: KGEnums.PLAYER_STATUS.MONITOR },
  { id: 'SS-9012384', risk: KGEnums.RISK.MEDIUM, riskScore: 53, riskFrom: 38, trend: 'up', spend: 8740, spendDelta: 54,
  ...
  { id: 'SS-1928374', risk: KGEnums.RISK.MEDIUM, riskScore: 49, trend: 'up', spend: 6210, spendDelta: 41,
    ...
    status: KGEnums.PLAYER_STATUS.MONITOR },
  { id: 'BK-2847362', risk: KGEnums.RISK.MEDIUM, riskScore: 44, trend: 'stable', spend: 287400, spendDelta: 38,
    ...
    status: KGEnums.PLAYER_STATUS.MONITOR },
  { id: 'BK-7382910', risk: KGEnums.RISK.MEDIUM, riskScore: 41, trend: 'down', spend: 198400, spendDelta: 22,
  ...
  { id: 'BK-9374821', risk: KGEnums.RISK.HIGH, riskScore: 84, trend: 'up', spend: 762400, spendDelta: 118,
    ...
    status: KGEnums.PLAYER_STATUS.OUTREACH },
  { id: 'SS-2647193', risk: KGEnums.RISK.HIGH, riskScore: 78, trend: 'up', spend: 18900, spendDelta: 87,
    ...
    status: KGEnums.PLAYER_STATUS.MONITOR },
  { id: 'BK-1738294', risk: KGEnums.RISK.HIGH, riskScore: 76, trend: 'up', spend: 654200, spendDelta: 76,
    ...
    status: KGEnums.PLAYER_STATUS.OUTREACH },
  { id: 'SS-4291837', risk: KGEnums.RISK.HIGH, riskScore: 73, trend: 'up', spend: 14200, spendDelta: 64,
  ...
  // ===== Additional medium =====
  { id: 'BK-8273619', risk: KGEnums.RISK.MEDIUM, riskScore: 58, trend: 'up', spend: 167300, spendDelta: 48,
    ...
    status: null },
  { id: 'SS-6182937', risk: KGEnums.RISK.MEDIUM, riskScore: 56, trend: 'up', spend: 7340, spendDelta: 36,
    ...
    status: KGEnums.PLAYER_STATUS.MONITOR },
  { id: 'BK-3927461', risk: KGEnums.RISK.MEDIUM, riskScore: 51, trend: 'stable', spend: 124600, spendDelta: 28,
    ...
    status: null },
  { id: 'SS-5183746', risk: KGEnums.RISK.MEDIUM, riskScore: 47, trend: 'up', spend: 5890, spendDelta: 33,
    ...
    status: null },
  { id: 'BK-4729183', risk: KGEnums.RISK.MEDIUM, riskScore: 45, trend: 'up', spend: 98700, spendDelta: 24,
  ...
  // ===== Low risk =====
  { id: 'SS-4738291', risk: KGEnums.RISK.LOW, riskScore: 22, trend: 'stable', spend: 3420, spendDelta: 4,
    ...
    status: null },
  { id: 'BK-1029384', risk: KGEnums.RISK.LOW, riskScore: 18, trend: 'down', spend: 87200, spendDelta: -18,
    ...
    status: null },
  { id: 'BK-6172839', risk: KGEnums.RISK.LOW, riskScore: 16, trend: 'stable', spend: 64800, spendDelta: 6,
    ...
    status: null },
  { id: 'SS-3829104', risk: KGEnums.RISK.LOW, riskScore: 14, trend: 'down', spend: 1840, spendDelta: -32,
    ...
    status: null },
  { id: 'BK-2918374', risk: KGEnums.RISK.LOW, riskScore: 12, trend: 'stable', spend: 42100, spendDelta: 2,
    deposits: 2, bets: 16, lastActive: '2d ago',
    insight: 'Recreational pattern, no flags',
    signals: [],
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 2, products: [KGEnums.PRODUCT.SPORTS],
    status: null },
  { id: 'SS-7361928', risk: KGEnums.RISK.LOW, riskScore: 10, trend: 'down', spend: 2180, spendDelta: -14,
    ...
    status: null },
  { id: 'BK-8472913', risk: KGEnums.RISK.LOW, riskScore: 8, trend: 'stable', spend: 28400, spendDelta: 1,
  ...
  { id: 'BK-5804359', risk: KGEnums.RISK.HIGH,   riskScore: 77, trend: 'up',     spend: 543200,  spendDelta: 89,
    ...
    status: KGEnums.PLAYER_STATUS.OUTREACH },
  { id: 'BK-9188862', risk: KGEnums.RISK.HIGH,   riskScore: 82, trend: 'up',     spend: 671000,  spendDelta: 104,
    ...
    status: KGEnums.PLAYER_STATUS.MONITOR },
  { id: 'BK-4873494', risk: KGEnums.RISK.HIGH,   riskScore: 79, trend: 'up',     spend: 498700,  spendDelta: 97,
    ...
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 5, products: [KGEnums.PRODUCT.SPORTS, KGEnums.PRODUCT.CASINO],
    status: KGEnums.PLAYER_STATUS.OUTREACH },
  { id: 'BK-8287974', risk: KGEnums.RISK.HIGH,   riskScore: 85, trend: 'up',     spend: 892300,  spendDelta: 121,
    ...
    status: KGEnums.PLAYER_STATUS.OUTREACH },
  { id: 'BK-9838926', risk: KGEnums.RISK.HIGH,   riskScore: 77, trend: 'up',     spend: 412500,  spendDelta: 86,
    deposits: 8,  bets: 149, lastActive: '2h ago',
    insight: '5 deposits in 28 min totalling ₦95,000 — record velocity',
    signals: ['Deposit frequency surge', 'Spend spike (>50% w/w)'],
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 4, products: [KGEnums.PRODUCT.SPORTS],
    status: KGEnums.PLAYER_STATUS.MONITOR },
  { id: 'BK-6735223', risk: KGEnums.RISK.HIGH,   riskScore: 85, trend: 'up',     spend: 1124000, spendDelta: 133,
    ...
    status: KGEnums.PLAYER_STATUS.OUTREACH },
  { id: 'BK-1736294', risk: KGEnums.RISK.HIGH,   riskScore: 74, trend: 'up',     spend: 321800,  spendDelta: 72,
    deposits: 7,  bets: 128, lastActive: '4h ago',
    insight: 'Two unanswered outreach calls; voicemail left',
    signals: ['Deposit frequency surge'],
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 4, products: [KGEnums.PRODUCT.SPORTS],
    status: KGEnums.PLAYER_STATUS.OUTREACH },
  { id: 'BK-1769791', risk: KGEnums.RISK.HIGH,   riskScore: 78, trend: 'up',     spend: 487200,  spendDelta: 91,
    deposits: 9,  bets: 176, lastActive: '1h ago',
    insight: 'Self-set ₦20,000/day deposit limit via app nudge',
    signals: ['Rapid re-deposit', 'Spend spike (>50% w/w)'],
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 5, products: [KGEnums.PRODUCT.CASINO],
    status: KGEnums.PLAYER_STATUS.MONITOR },
  { id: 'BK-2398779', risk: KGEnums.RISK.HIGH,   riskScore: 83, trend: 'up',     spend: 764100,  spendDelta: 115,
    ...
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 5, products: [KGEnums.PRODUCT.SPORTS, KGEnums.PRODUCT.CASINO],
    status: KGEnums.PLAYER_STATUS.OUTREACH },
  { id: 'BK-7382918', risk: KGEnums.RISK.HIGH,   riskScore: 74, trend: 'up',     spend: 287600,  spendDelta: 68,
    ...
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 3, products: [KGEnums.PRODUCT.SPORTS],
    status: KGEnums.PLAYER_STATUS.MONITOR },
  { id: 'BK-7336219', risk: KGEnums.RISK.HIGH,   riskScore: 79, trend: 'up',     spend: 398400,  spendDelta: 88,
    ...
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 4, products: [KGEnums.PRODUCT.SPORTS, KGEnums.PRODUCT.CASINO],
    status: KGEnums.PLAYER_STATUS.OUTREACH },
  { id: 'BK-4252587', risk: KGEnums.RISK.MEDIUM, riskScore: 48, trend: 'up',     spend: 112400,  spendDelta: 31,
    deposits: 4,  bets: 67,  lastActive: '6h ago',
    insight: 'Inbound: set ₦30,000/session loss limit; late-night shift flagged',
    signals: ['Late-night activity shift'],
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 3, products: [KGEnums.PRODUCT.CASINO],
    status: null },
  { id: 'BK-7882145', risk: KGEnums.RISK.MEDIUM, riskScore: 42, trend: 'stable', spend: 143700,  spendDelta: 18,
    deposits: 4,  bets: 58,  lastActive: '2d ago',
    insight: 'Self-excluded via product platform; 30-day period active',
    signals: [],
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 3, products: [KGEnums.PRODUCT.SPORTS],
    status: null },
  { id: 'BK-3321643', risk: KGEnums.RISK.MEDIUM, riskScore: 52, trend: 'up',     spend: 198300,  spendDelta: 44,
