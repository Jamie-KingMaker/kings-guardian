...
const PLAYERS = [
  ...
  { id: 'BK-4827193', risk: 'high', riskScore: 89, riskFrom: 62, trend: 'up', spend: 1842500, spendDelta: 142,
    ...
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 9, products: ['Sports', 'Casino'],
    status: 'outreach' },
  { id: 'SS-7283910', risk: 'high', riskScore: 92, riskFrom: 71, trend: 'up', spend: 24300, spendDelta: 215,
    ...
    country: KGEnums.COUNTRY.ZA, brand: KGEnums.BRAND.SUPERSPORTBET, tier: 8, products: ['Casino', 'Virtuals'],
    status: 'outreach' },
  { id: 'BK-3918274', risk: 'high', riskScore: 81, riskFrom: 58, trend: 'up', spend: 985000, spendDelta: 98,
    ...
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 8, products: ['Sports'],
    status: 'monitor' },
  { id: 'BK-5621847', risk: 'medium', riskScore: 61, riskFrom: 41, trend: 'up', spend: 412800, spendDelta: 67,
    ...
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 4, products: ['Sports', 'Casino'],
    status: 'monitor' },
  { id: 'SS-9012384', risk: 'medium', riskScore: 53, riskFrom: 38, trend: 'up', spend: 8740, spendDelta: 54,
    ...
    country: KGEnums.COUNTRY.ZA, brand: KGEnums.BRAND.SUPERSPORTBET, tier: 3, products: ['Sports', 'Virtuals'],
    status: null },
  ...
  { id: 'SS-1928374', risk: 'medium', riskScore: 49, trend: 'up', spend: 6210, spendDelta: 41,
    ...
    country: KGEnums.COUNTRY.ZM, brand: KGEnums.BRAND.SUPERSPORTBET, tier: 2, products: ['Sports'],
    status: 'monitor' },
  { id: 'BK-2847362', risk: 'medium', riskScore: 44, trend: 'stable', spend: 287400, spendDelta: 38,
    ...
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 5, products: ['Sports'],
    status: 'monitor' },
  ...
  { id: 'BK-9374821', risk: 'high', riskScore: 84, trend: 'up', spend: 762400, spendDelta: 118,
    ...
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 9, products: ['Casino'],
    status: 'outreach' },
  { id: 'SS-2647193', risk: 'high', riskScore: 78, trend: 'up', spend: 18900, spendDelta: 87,
    ...
    signals: ['Deposit frequency surge'],
    country: KGEnums.COUNTRY.ZA, brand: KGEnums.BRAND.SUPERSPORTBET, tier: 5, products: ['Sports', 'Casino'],
    status: 'monitor' },
  { id: 'BK-1738294', risk: 'high', riskScore: 76, trend: 'up', spend: 654200, spendDelta: 76,
    ...
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 8, products: ['Casino', 'Virtuals'],
    status: 'outreach' },
  { id: 'SS-4291837', risk: 'high', riskScore: 73, trend: 'up', spend: 14200, spendDelta: 64,
    ...
    country: KGEnums.COUNTRY.ZA, brand: KGEnums.BRAND.SUPERSPORTBET, tier: 5, products: ['Casino'],
    status: 'monitor' },
  ...
  { id: 'BK-8273619', risk: 'medium', riskScore: 58, trend: 'up', spend: 167300, spendDelta: 48,
    ...
    signals: ['Sports → Casino shift'],
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 4, products: ['Sports', 'Virtuals'],
    status: null },
  { id: 'SS-6182937', risk: 'medium', riskScore: 56, trend: 'up', spend: 7340, spendDelta: 36,
    ...
    country: KGEnums.COUNTRY.ZA, brand: KGEnums.BRAND.SUPERSPORTBET, tier: 3, products: ['Sports'],
    status: 'monitor' },
  { id: 'BK-3927461', risk: 'medium', riskScore: 51, trend: 'stable', spend: 124600, spendDelta: 28,
    ...
    signals: ['Spend spike (>50% w/w)'],
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 4, products: ['Sports'],
    status: null },
  { id: 'SS-5183746', risk: 'medium', riskScore: 47, trend: 'up', spend: 5890, spendDelta: 33,
    ...
    signals: ['Sports → Casino shift'],
    country: KGEnums.COUNTRY.ZA, brand: KGEnums.BRAND.SUPERSPORTBET, tier: 3, products: ['Sports', 'Casino'],
    status: null },
  { id: 'BK-4729183', risk: 'medium', riskScore: 45, trend: 'up', spend: 98700, spendDelta: 24,
    ...
    signals: ['Late-night activity shift'],
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 3, products: ['Casino'],
    status: null },
  ...
  { id: 'SS-4738291', risk: 'low', riskScore: 22, trend: 'stable', spend: 3420, spendDelta: 4,
    ...
    signals: [],
    country: KGEnums.COUNTRY.ZA, brand: KGEnums.BRAND.SUPERSPORTBET, tier: 4, products: ['Sports'],
    status: null },
  { id: 'BK-1029384', risk: 'low', riskScore: 18, trend: 'down', spend: 87200, spendDelta: -18,
    ...
    signals: [],
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 3, products: ['Sports'],
    status: null },
  { id: 'BK-6172839', risk: 'low', riskScore: 16, trend: 'stable', spend: 64800, spendDelta: 6,
    ...
    signals: [],
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 2, products: ['Sports'],
    status: null },
  { id: 'SS-3829104', risk: 'low', riskScore: 14, trend: 'down', spend: 1840, spendDelta: -32,
    ...
    signals: [],
    country: KGEnums.COUNTRY.ZM, brand: KGEnums.BRAND.SUPERSPORTBET, tier: 2, products: ['Virtuals'],
    status: null },
  ...
  { id: 'SS-7361928', risk: 'low', riskScore: 10, trend: 'down', spend: 2180, spendDelta: -14,
    ...
    signals: [],
    country: KGEnums.COUNTRY.ZA, brand: KGEnums.BRAND.SUPERSPORTBET, tier: 2, products: ['Sports'],
    status: null },
  { id: 'BK-8472913', risk: 'low', riskScore: 8, trend: 'stable', spend: 28400, spendDelta: 1,
    ...
    signals: [],
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 1, products: ['Sports'],
    status: null },
  ...
  { id: 'BK-5804359', risk: 'high',   riskScore: 77, trend: 'up',     spend: 543200,  spendDelta: 89,
    ...
    signals: ['Rapid re-deposit', 'Spend spike (>50% w/w)'],
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 5, products: ['Sports', 'Casino'],
    status: 'outreach' },
  { id: 'BK-9188862', risk: 'high',   riskScore: 82, trend: 'up',     spend: 671000,  spendDelta: 104,
    ...
    signals: ['Late-night activity shift', 'Spend spike (>50% w/w)'],
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 5, products: ['Casino'],
    status: 'monitor' },
  ...
  { id: 'BK-8287974', risk: 'high',   riskScore: 85, trend: 'up',     spend: 892300,  spendDelta: 121,
    ...
    signals: ['Rapid re-deposit', 'Spend spike (>50% w/w)'],
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 6, products: ['Casino'],
    status: 'outreach' },
  ...
  { id: 'BK-6735223', risk: 'high',   riskScore: 85, trend: 'up',     spend: 1124000, spendDelta: 133,
    ...
    signals: ['Late-night activity shift', 'Spend spike (>50% w/w)'],
    country: KGEnums.COUNTRY.NG, brand: KGEnums.BRAND.BETKING, tier: 6, products: ['Sports', 'Casino'],
    status: 'outreach' },
  ...
  { id: 'SS-2837461', risk: 'unrated', riskScore: null, trend: null, spend: 480, spendDelta: null,
    ...
    signals: [],
    country: KGEnums.COUNTRY.ZA, brand: KGEnums.BRAND.SUPERSPORTBET, tier: 1, products: ['Sports'],
    status: null },
