...
const KGEnums = Object.freeze({
  ...
  COMPONENT_ID: Object.freeze({
    ...
    TOPBAR_CUSTOMER_SEARCH_DATALIST: 'topbar-customer-search-datalist',
    PLAYER_DETAIL_PAGE: 'player-detail-page',
    PLAYER_DETAIL_BACK_BUTTON: 'player-detail-back-button',
    PLAYER_DETAIL_HEADER_CARD: 'player-detail-header-card',
    PLAYER_DETAIL_ACTION_ADD_NOTE_BUTTON: 'player-detail-action-add-note-button',
    PLAYER_DETAIL_ACTION_MONITOR_BUTTON: 'player-detail-action-monitor-button',
    PLAYER_DETAIL_ACTION_OUTREACH_BUTTON: 'player-detail-action-outreach-button',
    PLAYER_DETAIL_TAB_LIST: 'player-detail-tab-list',
    PLAYER_DETAIL_TAB_OVERVIEW_BUTTON: 'player-detail-tab-overview-button',
    PLAYER_DETAIL_TAB_INSIGHTS_BUTTON: 'player-detail-tab-insights-button',
    PLAYER_DETAIL_TAB_BEHAVIOUR_BUTTON: 'player-detail-tab-behaviour-button',
    PLAYER_DETAIL_TAB_LOG_BUTTON: 'player-detail-tab-log-button',
    PLAYER_DETAIL_OVERVIEW_PANEL: 'player-detail-overview-panel',
    PLAYER_DETAIL_OVERVIEW_RISK_SCORE_CARD: 'player-detail-overview-risk-score-card',
    PLAYER_DETAIL_OVERVIEW_STATS_GRID: 'player-detail-overview-stats-grid',
    PLAYER_DETAIL_OVERVIEW_SPEND_DEPOSITS_CARD: 'player-detail-overview-spend-deposits-card',
    PLAYER_DETAIL_OVERVIEW_PRODUCT_DISTRIBUTION_CARD: 'player-detail-overview-product-distribution-card',
    PLAYER_DETAIL_OVERVIEW_EXPLAINABILITY_CARD: 'player-detail-overview-explainability-card',
    PLAYER_DETAIL_INSIGHTS_PANEL: 'player-detail-insights-panel',
    PLAYER_DETAIL_INSIGHTS_CONTEXT_CARD: 'player-detail-insights-context-card',
    PLAYER_DETAIL_INSIGHTS_SIGNALS_CARD: 'player-detail-insights-signals-card',
    PLAYER_DETAIL_INSIGHTS_GRID: 'player-detail-insights-grid',
    PLAYER_DETAIL_INSIGHTS_ACTION_CARD: 'player-detail-insights-action-card',
    PLAYER_DETAIL_BEHAVIOUR_PANEL: 'player-detail-behaviour-panel',
    PLAYER_DETAIL_BEHAVIOUR_STATS_GRID: 'player-detail-behaviour-stats-grid',
    PLAYER_DETAIL_BEHAVIOUR_SPEND_DEPOSITS_CARD: 'player-detail-behaviour-spend-deposits-card',
    PLAYER_DETAIL_BEHAVIOUR_SESSION_TIMING_CARD: 'player-detail-behaviour-session-timing-card',
    PLAYER_DETAIL_BEHAVIOUR_PRODUCT_DISTRIBUTION_CARD: 'player-detail-behaviour-product-distribution-card',
    PLAYER_DETAIL_LOG_PANEL: 'player-detail-log-panel',
    PLAYER_DETAIL_LOG_HEADER: 'player-detail-log-header',
    PLAYER_DETAIL_LOG_ADD_NOTE_BUTTON: 'player-detail-log-add-note-button',
    PLAYER_DETAIL_SESSION_TIMING_CHART: 'player-detail-session-timing-chart',
    PLAYER_DETAIL_PRODUCT_DISTRIBUTION_CHART: 'player-detail-product-distribution-chart',
  }),
